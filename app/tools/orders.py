...
@mcp.tool(
    ...
    description=(
        ...
        "Obligatorio: antes de llamar a esta tool, muestra al usuario el resumen devuelto por "
        "add_to_cart y espera su confirmación explícita en un mensaje posterior. "
